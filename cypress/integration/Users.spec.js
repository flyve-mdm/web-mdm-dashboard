...
describe('Users', () => {
    beforeEach(function () {
        ...
        cy.route({
            method: 'GET',
            url: `${glpiApiLink}/search/User/?uid_cols=true&forcedisplay[0]=1&forcedisplay[1]=2&forcedisplay[2]=5&forcedisplay[3]=34&forcedisplay[4]=150&order=ASC&range=0-14&`,
            response: { 
                "totalcount": 2,
                "count": 2,
                "content-range": "0-1/2",
        ...
        cy.route({
            method: 'GET',
            url: `${glpiApiLink}/User/1/UserEmail`,
            response: [
